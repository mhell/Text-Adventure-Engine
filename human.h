...
namespace lab3  {
    ...
    /**
     * Class describing a default human actor
     */
    ...
    private:
		typedef bool (Human::*Command_ptr)(const std::string&, const std::string&, const Game_object&);
        ...
        /**
         * Use an object (by sending messege on : <target to it)
         */
        bool use(const std::string &item, const std::string &remains, const Game_object &caller);
		
        /**
         * Use an object (by sending messege on : <target to it)
         */
        bool give(const std::string &item, const std::string &remains, const Game_object &caller);
