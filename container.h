...
#ifndef LAB3_CONTAINER
#define LAB3_CONTAINER
...
namespace lab3  {
    ...
    /**
     * Class describing a default container item
     */
    ...
    private:
        typedef bool (Container::*Command_ptr)(const std::string&, const std::string&, const Game_object&);
